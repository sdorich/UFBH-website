<?php
$pageTitle = "UFBH Adoption Application";
$section = "adoption-app";
                ...
                <form action="../php/adoptionApp-process.php" method="post" name="enableform">
                    ...
                    <legend>Terms for Application Submission</legend>
                        <ol>
                            ...
                            <li>All of the information provided is true and complete to the best of my/our knowledge. I/we understand that a UFBH representative will contact me/us to schedule an appointment for a home visit. I/we understand that a donation/fee will be required, should I/we adopt a basset hound from Utah Friends of Basset Hounds. In the event that, for any reason, the basset hound shall be incompatible with me/us and/or my/our family, I/we promise to return the basset hound to UFBH without charge.
                            </li><br>
