...
<head>
    ...
    <link href="../js/jquery-ui-1.10.4.custom/css/hot-sneaks/jquery-ui-1.10.4.custom.css" rel="stylesheet">
    <link rel="stylesheet" href="../js/jMenu-master/css/jmenu.css" media="screen">
    <link type="text/css" rel="stylesheet" href="../js/jquery.selectBoxIt.js-master/src/stylesheets/jquery.selectBoxIt.css" />
    ...
    <div class="header">
        ...
        <div class="wrapper">
            ...
            <ul id="nav" class="nav">
                ...
                <li class="events <?php if ($section == "events") { echo "on"; } ?>"><a href="../events.php">Events!</a></li>
            </ul>
